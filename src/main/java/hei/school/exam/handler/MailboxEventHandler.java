package hei.school.exam.handler;

import static hei.school.exam.concurrency.ThreadRenamer.renameWorkerThread;
...
import hei.school.exam.PojaApplication;
import hei.school.exam.PojaGenerated;
import hei.school.exam.endpoint.EndpointConf;
import hei.school.exam.endpoint.event.EventConf;
import hei.school.exam.endpoint.event.consumer.EventConsumer;
import hei.school.exam.endpoint.event.consumer.model.ConsumableEvent;
import hei.school.exam.endpoint.event.consumer.model.ConsumableEventTyper;
